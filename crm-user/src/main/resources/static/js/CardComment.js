...
(function(){
	...
	Run.define("CardComment",(function(){
		...
		return {
			...
			privates : {
				...
				_createCard : function (data, i) {
					var _html = '<div class="commentCardItem clearfix">'
									+'<span class="left commentName">'+data.name+'</span>'
									+'<div class="left commentRight">'
										+'<p>'+data.content+'</p>'
										+'<span class="msgCartTime right">'+data.time+'</span>'
									+'</div>'
								+'</div>';
				    return _html;	
				},
