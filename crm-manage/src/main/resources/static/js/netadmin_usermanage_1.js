$(function(){
	...
	var configs = [{
		id : "input_3",
		width : 204,
		url : "json/netadmin_usermanage.json",
		listeners:{
			render:function(){
				//console.log(this.id)
    ...
    grid("gridBox","json/netadmin_usermanageGrid.json",taskCenterColModel,taskCenterConfig);
...
//		return "<span>已阅评<em class='orange'>"+val+"</em>篇</span>";
		return "<span class='cando'><a href='#' class='eye'></a><a href='#' class='edit'></a><a href='#' class='delete'></a></span>";
	}
