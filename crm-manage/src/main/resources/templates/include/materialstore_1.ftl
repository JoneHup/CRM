<div class="materialCardBox">
	<div class="clearfix materialCardTotal">
        ...
        <div class="right" id="materialStoreComb_4"></div>
...
<script type="text/javascript" src="${basePath}/js/CardMaterial.js"></script>
<script type="text/javascript" src="${basePath}/js/materialstore_1.js"></script>