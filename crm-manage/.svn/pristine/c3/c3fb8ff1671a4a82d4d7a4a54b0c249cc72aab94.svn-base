...
<title>网评管理系统 -素材库-共享素材-评论素材审批</title>
...
<script type="text/javascript" src="js/commentshare_add.js"></script>
</head>
...
<div class="wrap">
	<div class="title clearfix">
    	<h3 class="left">素材库-共享素材-评论素材审批</h3>
  </div>
        
        <div class="normalGridBox">
        	<div id="commentshare_addGrid" class="taskCenterGrid"></div>
        </div>
