...
<title>网评管理系统 - 后台管理-阅评员管理-组织管理-新建组织机构</title>
...
<#include "/common/common-js.ftl">
    ...
    <script type="text/javascript" src="/js/readadmin_organizationadd.js"></script>
</head>
...
<div class="wrap">
	<div class="title clearfix">
    	<h3 class="left">后台管理-阅评员管理-组织管理-新建组织机构</h3>
