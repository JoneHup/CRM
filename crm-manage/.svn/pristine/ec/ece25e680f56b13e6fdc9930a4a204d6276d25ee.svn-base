$(function(){
	$(".userManageTabHd li").each(function(i){
		$(this).click(function(){
			...
			if($.trim($(".userManageTabBd .userManageTabBdItem").eq(i).html()) === ""){
				var pageName = "";
				if(i === 0){
					pageName = "readadmin_usermanage_1";
				}else if(i === 1){
					pageName = "readadmin_usermanage_2";
				}else if(i === 2){
					pageName = "readadmin_usermanage_3";
				}
	...
	//页面初始加载第一屏标签页
	include("include/readadmin_usermanage_1.html",function(text){
