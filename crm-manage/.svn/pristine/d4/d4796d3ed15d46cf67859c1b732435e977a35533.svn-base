...
<title>网评管理系统 - 业务人员 - 业务管理 - 业务人员账号添加</title>
...
<div class="wrap">
	<div class="title clearfix">
    	<h3 class="left">后台管理-业务人员管理-用户管理-新建账号</h3>
    ...
    <div class="userManage">
    	<ul class="accountAddList clearfix">
        	<li class="clearfix">
                ...
                <input type="text" class="left accountInput" placeholder="用户账号为4~20个小写英文字母" id="user_account"/>
                <label class="left txt"><em class="orange">*</em>密码：</label>
                <input type="text" class="left accountInput" placeholder="用户密码为6~9个纯数字"  id="user_password"/>
           </li>
        	<li class="clearfix">
            	<label class="left txt"><em class="orange">*</em>姓名：</label>
                <input type="text" class="left accountInput" placeholder="用户姓名为1~10个汉字"  id="user_name"/>
                ...
                <label class="radioLabel left"><input type="radio" class="left" name="performance" checked  value="1"/><span class="left">男</span></label>
				<label class="radioLabel left marginL10"><input type="radio" class="left" name="performance"    value="2"/><span class="left">女</span></label>
           </li>
        	<li class="clearfix">
            	<label class="left txt">职务：</label>
                <input type="text" class="left accountInput" placeholder="请输入用户职务" id="user_job" />
                <label class="left txt">身份证号：</label>
                <input type="text" class="left accountInput" placeholder="请输入用户身份证号"  id="user_identityCode"/>
           </li>
        	<li class="clearfix">
            	<label class="left txt"><em class="orange">*</em>手机：</label>
                <input type="text" class="left accountInput" placeholder="请输入用户手机号"  id="user_telephone" />
                <label class="left txt">电子邮箱：</label>
                <input type="text" class="left accountInput" placeholder="请输入用户电子邮箱"  id="user_email"/>
           </li>
        	<li class="clearfix">
            	<label class="left txt">座机：</label>
                <input type="text" class="left accountInput" placeholder="用户座机格式xxx-xxxxxxxx" id="user_mobileN" />
                <label class="left txt">分机号：</label>
                <input type="text" class="left accountInput" placeholder="分机号为纯数字"  id="user_extenNumber"/>
           </li>
        	<li class="clearfix">
            	<label class="left txt">编号：</label>
                <input type="text" class="left accountInput" placeholder="请输入用户编号"  id="user_userCode"/>
    ...
    <div class="footerBtn">
    	<a href="javascript:void(0)" class="right back">返回</a>
		<a href="javascript:void(0)" class="right accountpublish">提交</a>
    </div>
