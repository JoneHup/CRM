...
<title>网评管理系统 - 后台管理-业务人员管理-组织管理-查看成员</title>
...
<script type="text/javascript" src="/js/admin_organizationcheckperson.js"></script>
</head>
...
<div class="wrap">
	<div class="title clearfix">
    	<h3 class="left">后台管理-业务人员管理-组织管理-查看成员</h3>
    </div>
    ...
    <div class="taskBox">
        ...
        <div class="organizationNameBox">
	    	<h3 class="organizationName">组织机构1(所在地)</h3>
    	</div>
