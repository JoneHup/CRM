$(function(){
    ...
    grid("gridBox_3","json/admin_rolemanageGrid.json",taskCenterColModel,taskCenterConfig);
...
//		var row = JSON.stringify(row);
		...
		return "<a href='admin_roleedit_basicinfo.html' class='organizationedit' title='编辑'></a><a href='#' class='organizationdelete' title='删除' onclick='materialDelete()'></a>";
	}
