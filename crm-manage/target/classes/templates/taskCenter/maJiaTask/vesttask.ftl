...
<script type="text/javascript" src="/js/vesttask.js"></script>
</head>
...
<div class="wrap">
    ...
    <div class="taskBox">
        	...
        	<div class="longBoxTop">
            	<div class="longBoxCenter">
                	<ul class="taskList_1">
                        ...
                        <li class="clearfix">
                        	<label class="left">下发时间：</label>
                            <input type="text" class="left timeInput j_toTimeSS" />
                            <span class="left timeSep">—</span>
                            <input type="text" class="left timeInput j_toTimeSS" />
                        	<label class="left">任务平台：</label>
                            <input type="text" class="left longInput" />
        ...
        <div class="normalGridBox">
        	<div id="vestGrid" class="vestGrid"></div>
        </div>
