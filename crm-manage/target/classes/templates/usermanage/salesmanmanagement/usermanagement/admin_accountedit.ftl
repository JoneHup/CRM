...
<title>网评管理系统 -后台管理-业务人员管理-用户管理-编辑账号</title>
...
<script type="text/javascript" src="/js/admin_accountedit.js"></script>
</head>
...
<div class="wrap">
	<div class="title clearfix">
    	<h3 class="left">后台管理-业务人员管理-用户管理-编辑账号</h3>
    ...
    <div class="userManage">
    	<ul class="accountAddList clearfix">
        	...
        	<li class="clearfix">
                ...
                <label class="radioLabel left"><input type="radio" class="left" name="performance" checked/><span class="left">男</span></label>
