$(function(){
	$(".userManageTabHd li").each(function(i){
		$(this).click(function(){
			...
			if($.trim($(".userManageTabBd .userManageTabBdItem").eq(i).html()) === ""){
				var pageName = "";
				if(i === 0){
					pageName = "admin_organizationmanage_1";
				}else if(i === 1){
					pageName = "admin_organizationmanage_2";
				}else if(i === 2){
					pageName = "admin_organizationmanage_3";
				}
	...
	//页面初始加载第一屏标签页
	include("include/admin_organizationmanage_1.html",function(text){
